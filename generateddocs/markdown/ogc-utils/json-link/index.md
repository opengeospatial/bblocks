...
* YAML version: [schema.yaml](https://blocks.ogc.org/annotated-schemas/ogc-utils/json-link/schema.json)
* JSON version: [schema.json](https://blocks.ogc.org/annotated-schemas/ogc-utils/json-link/schema.yaml)
...
[context.jsonld](https://blocks.ogc.org/annotated-schemas/ogc-utils/json-link/context.jsonld)
