...
- $schema: https://json-schema.org/draft/2019-09/schema
  ...
  properties:
    ...
    features:
      type: array
      items:
        $ref: https://blocks.ogc.org/annotated-schemas/geo/json-fg/feature-lenient/schema.yaml
...
* YAML version: [schema.yaml](https://blocks.ogc.org/annotated-schemas/geo/json-fg/featureCollection-lenient/schema.json)
* JSON version: [schema.json](https://blocks.ogc.org/annotated-schemas/geo/json-fg/featureCollection-lenient/schema.yaml)
...
[context.jsonld](https://blocks.ogc.org/annotated-schemas/geo/json-fg/featureCollection-lenient/context.jsonld)
