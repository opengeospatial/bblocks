...
{
  "@context": [
    "https://blocks.ogc.org/annotated-schemas/geo/json-fg/link-role/context.jsonld",
    {
      "@base": "http://example.org"
    }
  ],
...
$defs:
  ...
  coderefs:
    $ref: https://blocks.ogc.org/annotated-schemas/ogc-utils/iri-or-curie/schema.yaml#/$defs/MultipleOrObjectOrNull
allOf:
...
* YAML version: [schema.yaml](https://blocks.ogc.org/annotated-schemas/geo/json-fg/link-role/schema.json)
* JSON version: [schema.json](https://blocks.ogc.org/annotated-schemas/geo/json-fg/link-role/schema.yaml)
...
[context.jsonld](https://blocks.ogc.org/annotated-schemas/geo/json-fg/link-role/context.jsonld)
