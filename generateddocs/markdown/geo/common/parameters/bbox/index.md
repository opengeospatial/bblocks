...
![Bounding box for the continental US states](http://blocks.ogc.org/registereditems/geo/common/parameters/bbox/assets/example.png)
...
* YAML version: [schema.yaml](http://blocks.ogc.org/annotated-schemas/geo/common/parameters/bbox/schema.json)
* JSON version: [schema.json](http://blocks.ogc.org/annotated-schemas/geo/common/parameters/bbox/schema.yaml)
