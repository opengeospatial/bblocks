...
{
  "@context": [
    "https://blocks.ogc.org/annotated-schemas/geo/features/featureCollection/context.jsonld",
    {
      "my": "http://my.org/featureTypes/",
      "skos": "http://www.w3.org/2004/02/skos/core#",
      "name": "skos:prefLabel"
...
* YAML version: [schema.yaml](https://blocks.ogc.org/annotated-schemas/geo/features/featureCollection/schema.json)
* JSON version: [schema.json](https://blocks.ogc.org/annotated-schemas/geo/features/featureCollection/schema.yaml)
...
[context.jsonld](https://blocks.ogc.org/annotated-schemas/geo/features/featureCollection/context.jsonld)
