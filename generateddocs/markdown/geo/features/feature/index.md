...
```jsonld
{
  "@context": "https://blocks.ogc.org/annotated-schemas/geo/features/feature/context.jsonld",
  "id": "f1",
  "type": "Feature",
  "geometry": {
    "type": "Point",
...
```yaml
allOf:
- $ref: https://blocks.ogc.org/annotated-schemas/geo/common/data_types/geojson/schema.yaml
- type: object
  properties:
    bbox:
      $ref: https://blocks.ogc.org/annotated-schemas/geo/common/data_types/bounding_box/schema.yaml
    links:
      type: array
      items:
...
* YAML version: [schema.yaml](https://blocks.ogc.org/annotated-schemas/geo/features/feature/schema.json)
* JSON version: [schema.json](https://blocks.ogc.org/annotated-schemas/geo/features/feature/schema.yaml)
...
[context.jsonld](https://blocks.ogc.org/annotated-schemas/geo/features/feature/context.jsonld)
