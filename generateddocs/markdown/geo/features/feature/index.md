...
```jsonld
{
  "@context": "http://blocks.ogc.org/annotated-schemas/geo/features/feature/context.jsonld",
  "id": "f1",
  "type": "Feature",
  "geometry": {
    "type": "Point",
...
```yaml
allOf:
- $ref: http://blocks.ogc.org/annotated-schemas/geo/common/data_types/geojson/schema.yaml
- type: object
  properties:
    bbox:
      $ref: http://blocks.ogc.org/annotated-schemas/geo/common/data_types/bounding_box/schema.yaml
    links:
      type: array
      items:
...
* YAML version: [schema.yaml](http://blocks.ogc.org/annotated-schemas/geo/features/feature/schema.json)
* JSON version: [schema.json](http://blocks.ogc.org/annotated-schemas/geo/features/feature/schema.yaml)
...
[context.jsonld](http://blocks.ogc.org/annotated-schemas/geo/features/feature/context.jsonld)
