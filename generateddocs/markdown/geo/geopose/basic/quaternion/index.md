...
* YAML version: [schema.yaml](http://blocks.ogc.org/annotated-schemas/geo/geopose/basic/quaternion/schema.json)
* JSON version: [schema.json](http://blocks.ogc.org/annotated-schemas/geo/geopose/basic/quaternion/schema.yaml)
...
[context.jsonld](http://blocks.ogc.org/annotated-schemas/geo/geopose/basic/quaternion/context.jsonld)
