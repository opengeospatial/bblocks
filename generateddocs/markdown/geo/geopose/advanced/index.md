...
* YAML version: [schema.yaml](http://blocks.ogc.org/annotated-schemas/geo/geopose/advanced/schema.json)
* JSON version: [schema.json](http://blocks.ogc.org/annotated-schemas/geo/geopose/advanced/schema.yaml)
...
[context.jsonld](http://blocks.ogc.org/annotated-schemas/geo/geopose/advanced/context.jsonld)
