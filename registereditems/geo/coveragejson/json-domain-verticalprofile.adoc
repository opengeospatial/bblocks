=== VerticalProfile
==== Overview
VerticalProfile is a coverage domain type. A VerticaProfile can only contain `[x,y,z]` positions (and not additional coordinates):
...
==== Examples
See some Examples in the https://opengeospatial.github.io/ogcna-auto-review/21-069.html#polygon[Standard, Clause 9.10.2].
