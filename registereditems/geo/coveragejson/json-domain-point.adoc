=== Point
==== Overview
Point is a coverage domain type. A Point can only contain `[x,y]` positions (and not `z` or additional coordinates):
...
==== Source Reference
It is defined in the https://docs.ogc.org/is/19-086r5/19-086r5.html#polygon[OGC CoverageJSON Community Standard, Section 9.10.4] which is maintained by the OGC Coverages Standard Working Group using this https://github.com/opengeospatial/CoverageJSON[OGC GitHub repository].

==== Maturity
Stable

==== Pre-defined Properties of the Point Domain Object 
[width="100%",cols="22%,22%,14%,42%",frame="topbot",options="header"]
.Polygon Domain Object
|==========================
|Field Name|Type|Required|Description
|domainType |String|**Yes**|Always `"Point"`
...
===== Example 1, Point Domain - rectangle
...
----
===== Example 2, Coverage using a Point Domain 
